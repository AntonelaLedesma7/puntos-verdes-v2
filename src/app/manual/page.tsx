        ...
        <div className="space-y-6">
          ...
          <section className="p-4 bg-[--color-secundary] rounded-lg shadow-md">
            ...
            <p className="text-white">
              Reciclar es crucial para reducir la contaminación y conservar los
              recursos naturales. A través del reciclaje, podemos disminuir la
              cantidad de basura que va a los vertederos y promover un ambiente
          ...
          <section className="p-4 bg-[--color-secundary] rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-white list-disc list-inside">
              <li>
                Los materiales reciclables comunes incluyen papel, cartón,
                vidrio, plástico y metal.
              </li>
              <li>
                Lava y limpia los materiales reciclables antes de desecharlos.
              </li>
              <li>
                Separa los materiales en categorías: reciclables y no
                reciclables.
              </li>
              <li>
                Identifica los puntos de reciclaje cercanos en nuestro mapa
                interactivo.
              </li>
            </ul>
          </section>
          ...
          <section className="p-4 bg-[--color-secundary] rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
              ...
              <div>
                <h3 className="mb-4 font-semibold text-[--color-primary]">
                  Materiales reciclables:
                </h3>
