...
// Definir tipos para los materiales y la ubicación
interface Material {
...
function ConfirmationPageContent() {
  ...
  const { selectedMaterials, selectedLocation }: { selectedMaterials: Material[]; selectedLocation: Location | null } = useRecycleStore();
