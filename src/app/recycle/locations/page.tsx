...
export default function Locations() {
  ...
  const { setSelectedLocation } = useRecycleStore();

  // Memoriza el array de ubicaciones para evitar que cambie en cada render
  ...
  return (
    <div className="grid gap-6">
      ...
      <div>
        ...
        >
          <SelectTrigger
            className={`${styles.selectTrigger} w-[280px] text-black`}
          >
